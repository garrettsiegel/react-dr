...
[![version](https://img.shields.io/npm/v/react-dr?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/react-dr)
[![downloads](https://img.shields.io/npm/dt/react-dr.svg?style=flat&colorA=000000&colorB=000000)](https://npmjs.com/package/react-dr)

Let coding agents diagnose and fix your React code.

This project is a security-hardened fork of React Doctor, published as react-dr.
...
```bash
cp skills/react-doctor/SKILL.md ~/.claude/skills/react-doctor/SKILL.md
```
...
- run: npx -y react-dr@1.0.0 . --diff main --fail-on error
```
...
```
Usage: react-dr [directory] [options]
...
```js
import { diagnose } from "react-dr/api";
